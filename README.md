...
<p align="center">
  <img alt="Version" src="https://img.shields.io/badge/version-1.1.1-0f766e">
...
| 镜像 | 容器端口 | 职责 |
| --- | --- | --- |
| `firefly/firefly-server:1.1.1` | `9700`、`9710`、`9711` | Gateway、Admin API、Scheduler、Metrics |
| `firefly/firefly-admin-ui:1.1.1` | `9720` | Web UI、浏览器会话和 Admin API 反向代理 |

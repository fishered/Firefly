...
```powershell
docker tag firefly/firefly-server:1.1.4 registry.example.com/firefly/firefly-server:1.1.4
docker tag firefly/firefly-admin-ui:1.1.4 registry.example.com/firefly/firefly-admin-ui:1.1.4
docker push registry.example.com/firefly/firefly-server:1.1.4
docker push registry.example.com/firefly/firefly-admin-ui:1.1.4
```

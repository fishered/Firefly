...
```powershell
docker build -t firefly/firefly-server:1.1.0 -f Dockerfile .
docker build -t firefly/firefly-admin-ui:1.1.0 -f ui/admin/Dockerfile ui/admin
```
...
```powershell
docker tag firefly/firefly-server:1.1.0 registry.example.com/firefly/firefly-server:1.1.0
docker tag firefly/firefly-admin-ui:1.1.0 registry.example.com/firefly/firefly-admin-ui:1.1.0
docker push registry.example.com/firefly/firefly-server:1.1.0
docker push registry.example.com/firefly/firefly-admin-ui:1.1.0
```

...
```powershell
docker build -t firefly/firefly-server:1.0.8 -f Dockerfile .
docker build -t firefly/firefly-admin-ui:1.0.8 -f ui/admin/Dockerfile ui/admin
```
...
```powershell
docker tag firefly/firefly-server:1.0.8 registry.example.com/firefly/firefly-server:1.0.8
docker tag firefly/firefly-admin-ui:1.0.8 registry.example.com/firefly/firefly-admin-ui:1.0.8
docker push registry.example.com/firefly/firefly-server:1.0.8
docker push registry.example.com/firefly/firefly-admin-ui:1.0.8
```
